...
class Cards extends React.Component {
  ...
  render() {
    ...
    //returns this web page
    return (
      <div>
        <div className="container">
          <div className="row">
            <h1 className="cap">
              {user.user.userName}s {this.state.cat.catName} Cards:
            </h1>
        ...
        <div className="container">
          <div className="row">
            ...
            <button
              className="marleft btn waves-effect waves-light"
              onClick={this.superhero}>
              superhero
            </button>
          </div>
        </div>
